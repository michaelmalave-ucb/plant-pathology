...
#base_learning_rate = 0.001 #hr commented out, replaced with learning rate exponential decay
...
def main():
    ...
    x = tf.keras.layers.GaussianNoise(0.2)(x) #hr added
...
#hr added metrics
    ...
    model.compile(optimizer=tf.keras.optimizers.Adam(lr_schedule), #pass learning rate in
...
#hr added different metrics plots
    ...
    # plt.plot(epochs_range, prc, label='prc')
